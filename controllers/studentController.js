...
const registerStudent = async (req, res) => {
    ...
    const { name, roll_no, room_no, batch, dept, course, email, father_name, contact, address, dob, aadhar, hostel, password } = req.body;
    try {
...
const updateStudent = async (req, res) => {
    ...
    try {
        ...
        const { name, roll_no, room_no, batch, dept, course, email, father_name, contact, address, dob, aadhar, user, hostel } = req.body;
...
const csvStudent = async (req, res) => {
    ...
    try {
        ...
        students.forEach(student => {
            ...
            student.aadhar_no = student.aadhar.slice(0, 5) + '-' + student.aadhar.slice(5, 12) + '-' + student.aadhar.slice(12);
